...
#     user1 = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="Відправник", related_name="Poster")#, initial='{{request.user}}'
...
#         ordering = ['user2']
    ...
    # def save(self, *args, **kwargs):
    #     if Shares.objects.filter(user=self.user, puzzle=self.puzzle):
    #         return
    #     else:
    #         super().save(*args, **kwargs)
        # print(self)
        ...
        #     raise ValueError("Ви не можете радити собі статті")
        #
        # super().save(*args, **kwargs)
